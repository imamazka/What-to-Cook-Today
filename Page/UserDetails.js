    ...
    return (
        <View style={{flex: 1, backgroundColor: colors.white,}}>  
            ...
            <View style={{flex:1, backgroundColor:colors.white}}>
                ...
                <View>
                    <Text style={{fontWeight:'bold', fontSize: 18, textAlign: 'center'}}>User</Text>
                    <Text style={{fontWeight:'bold', fontSize: 13, textAlign: 'center', color: colors.grey}}>user@gmail.com</Text>
                    <View style={{marginTop:30}}>
                        ...
                        <TouchableOpacity style={{ padding: 10 }} onPress={() => navigation.navigate('Favorite')}>
                           <View style={{flexDirection:'row', marginHorizontal:20}}>
                            <View style={{flex:1.5}}>
            ...
            <View style={Styles.navWrapper}>
                ...
                <TouchableOpacity>
                    <View style={Styles.sectionWrapper}>
                        <Ionicons name='person-outline' color={colors.mainGreen} size={22} style={{ right: 4 }}></Ionicons>
